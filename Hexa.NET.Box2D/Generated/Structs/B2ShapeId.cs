...
{
	/// <summary>
	/// Shape id references a shape instance. This should be treated as an opaque handle.<br/>
	/// </summary>
	[NativeName(NativeNameType.StructOrClass, "b2ShapeId")]
	...
	public partial struct B2ShapeId
	{
		...
		public unsafe B2ShapeId(int index1 = default, ushort world0 = default, ushort revision = default)
		{
			Index1 = index1;
			World0 = world0;
			Revision = revision;
