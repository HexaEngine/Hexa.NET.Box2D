...
{
	/// <summary>
	/// A distance proxy is used by the GJK algorithm. It encapsulates any shape.<br/>
	/// </summary>
	[NativeName(NativeNameType.StructOrClass, "b2DistanceProxy")]
	...
	public partial struct B2DistanceProxy
	{
		...
		/// <summary>
		/// The external radius of the point cloud<br/>
		/// </summary>
		...
		public unsafe B2DistanceProxy(Vector2* points = default, int count = default, float radius = default)
		{
		...
		public unsafe B2DistanceProxy(Span<Vector2> points = default, int count = default, float radius = default)
		{
