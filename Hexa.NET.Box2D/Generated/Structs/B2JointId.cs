...
{
	/// <summary>
	/// Joint id references a joint instance. This should be treated as an opaque handle.<br/>
	/// </summary>
	[NativeName(NativeNameType.StructOrClass, "b2JointId")]
	...
	public partial struct B2JointId
	{
		...
		public unsafe B2JointId(int index1 = default, ushort world0 = default, ushort revision = default)
		{
			Index1 = index1;
			World0 = world0;
			Revision = revision;
