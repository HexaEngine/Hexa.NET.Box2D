...
namespace Hexa.NET.Box2D
{
	...
	/// <br/>
	/// </summary>
	[NativeName(NativeNameType.StructOrClass, "b2PrismaticJointDef")]
	...
	public partial struct B2PrismaticJointDef
	{
		...
		/// <summary>
		/// The constrained angle between the bodies: bodyB_angle - bodyA_angle<br/>
		/// </summary>
		...
		/// <summary>
		/// Enable a linear spring along the prismatic joint axis<br/>
		/// </summary>
		...
		/// <summary>
		/// The maximum motor force, typically in newtons<br/>
		/// </summary>
		...
		/// <summary>
		/// The desired motor speed, typically in meters per second<br/>
		/// </summary>
		...
		public unsafe B2PrismaticJointDef(B2BodyId bodyIdA = default, B2BodyId bodyIdB = default, Vector2 localAnchorA = default, Vector2 localAnchorB = default, Vector2 localAxisA = default, float referenceAngle = default, bool enableSpring = default, float hertz = default, float dampingRatio = default, bool enableLimit = default, float lowerTranslation = default, float upperTranslation = default, bool enableMotor = default, float maxMotorForce = default, float motorSpeed = default, bool collideConnected = default, void* userData = default, int internalValue = default)
		{
			BodyIdA = bodyIdA;
			BodyIdB = bodyIdB;
