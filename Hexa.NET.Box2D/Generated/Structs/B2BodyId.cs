...
{
	/// <summary>
	/// Body id references a body instance. This should be treated as an opaque handle.<br/>
	/// </summary>
	[NativeName(NativeNameType.StructOrClass, "b2BodyId")]
	...
	public partial struct B2BodyId
	{
		...
		public unsafe B2BodyId(int index1 = default, ushort world0 = default, ushort revision = default)
		{
			Index1 = index1;
			World0 = world0;
			Revision = revision;
